...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-[#050505]">
    <head>
        ...
        <link rel="apple-touch-icon-precomposed" type="image/x-icon" href="/favicon.png" />
        <link rel="apple-touch-startup-image" type="image/x-icon" href="/favicon.png" />
        <link rel="favicon" type="image/x-icon" href="/favicon.png" />
        @routes
    ...
    <body class="font-sans antialiased h-full">
        ...
        <script type="application/javascript">
            window.translations = <?php echo file_get_contents(resource_path("lang/".app()->getLocale().".json")); ?>;
        </script>
    </body>
</html>

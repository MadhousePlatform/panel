    ...
    <jet-action-section>
        ...
        <template #content>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-zinc-3600">
                ...
                <div v-if="recoveryCodes.length > 0">
                    ...
                    <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-zinc-900 text-white rounded-lg">
...
import JetButton from '@/Components/MadhouseButton'
